# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-13 14:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='role',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='host.UserRole'),
        ),
        migrations.AddField(
            model_name='services',
            name='owner',
            field=models.ManyToManyField(to='host.User'),
        ),
        migrations.AddField(
            model_name='idc',
            name='owner',
